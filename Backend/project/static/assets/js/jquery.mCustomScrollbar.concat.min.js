  ...
  (oe = "function" == typeof define && define.amd),
            ...
            "x" !== n.axis &&
              (a.overflowed[0]
                ? l[0].height() > l[0].parent().height()
                  ? b.call(this)
                  : (N(t, c[0].toString(), { dir: "y", dur: 0, overwrite: "none" }), (a.contentReset.y = null))
                : (b.call(this), "y" === n.axis ? B.call(this) : "yx" === n.axis && a.overflowed[1] && N(t, c[1].toString(), { dir: "x", dur: 0, overwrite: "none" }))),
              "y" !== n.axis &&
                (a.overflowed[1]
                  ? l[1].width() > l[1].parent().width()
                    ? b.call(this)
                    : (N(t, c[1].toString(), { dir: "x", dur: 0, overwrite: "none" }), (a.contentReset.x = null))
                  : (b.call(this), "x" === n.axis ? B.call(this) : "yx" === n.axis && a.overflowed[0] && N(t, c[0].toString(), { dir: "y", dur: 0, overwrite: "none" }))),
              o &&
                a &&
                (2 === o && n.callbacks.onImageLoad && "function" == typeof n.callbacks.onImageLoad
                  ? n.callbacks.onImageLoad.call(this)
                  : 3 === o && n.callbacks.onSelectorChange && "function" == typeof n.callbacks.onSelectorChange
                  ? n.callbacks.onSelectorChange.call(this)
                  : n.callbacks.onUpdate && "function" == typeof n.callbacks.onUpdate && n.callbacks.onUpdate.call(this)),
              Y.call(this);
          }
        });
      },
        ...
        if (void 0 !== t && null != t) {
          ...
          return e(a).each(function () {
            ...
            if (a.data("mCS")) {
              var n = a.data("mCS"),
                i = n.opt,
                r = { trigger: "external", scrollInertia: i.scrollInertia, scrollEasing: "mcsEaseInOut", moveDragger: !1, timeout: 60, callbacks: !0, onStart: !0, onUpdate: !0, onComplete: !0 },
                l = e.extend(!0, {}, r, o),
                s = q.call(this, t),
              ...
              (s[0] = j.call(this, s[0], "y")),
                ...
                (l.dur = te() ? 0 : c),
                setTimeout(function () {
                  null !== s[0] && void 0 !== s[0] && "x" !== i.axis && n.overflowed[0] && ((l.dir = "y"), (l.overwrite = "all"), N(a, s[0].toString(), l)), null !== s[1] && void 0 !== s[1] && "y" !== i.axis && n.overflowed[1] && ((l.dir = "x"), (l.overwrite = "none"), N(a, s[1].toString(), l));
                }, l.timeout);
            }
          });
        }
    ...
    (p = function () {
      ...
      n.setWidth && t.css("width", n.setWidth),
        ...
        t
          .addClass(o + " _mCS_" + a.idx + u + f)
          .wrapInner("<div id='mCSB_" + a.idx + "' class='mCustomScrollBox mCS-" + n.theme + " " + l + "'><div id='mCSB_" + a.idx + "_container' class='mCSB_container' style='position:relative; top:" + n.setTop + "; left:" + n.setLeft + ";' dir='" + a.langDir + "' /></div>");
      var m = e("#mCSB_" + a.idx),
    ...
    (v = function () {
      ...
      if (a.advanced.autoExpandHorizontalScroll && "y" !== a.axis) {
        ...
        3 === a.advanced.autoExpandHorizontalScroll || (2 !== a.advanced.autoExpandHorizontalScroll && i > n.parent().width())
          ? n.css({ width: i, "min-width": "100%", "overflow-x": "inherit" })
          : n
    ...
    (b = function () {
      ...
      X(a),
        (("x" !== i.axis && !n.overflowed[0]) || ("y" === i.axis && n.overflowed[0])) && (s[0].add(l).css("top", 0), N(a, "_resetY")),
        (("y" !== i.axis && !n.overflowed[1]) || ("x" === i.axis && n.overflowed[1])) && ((t = o = 0), "rtl" === n.langDir && ((t = r.width() - l.outerWidth(!1)), (o = Math.abs(t / n.scrollRatio.x))), l.css("left", t), s[1].css("left", o), N(a, "_resetX"));
    }),
    (y = function () {
      var t = e(this),
        o = t.data("mCS"),
      ...
      if (!o.bindEvents) {
        var n;
        if ((M.call(this), a.contentTouchScroll && O.call(this), I.call(this), a.mouseWheel.enable))
          !(function o() {
            n = setTimeout(function () {
              e.event.special.mousewheel ? (clearTimeout(n), D.call(t[0])) : o();
            }, 100);
          })();
        L.call(this), P.call(this), a.advanced.autoScrollOnFocus && z.call(this), a.scrollButtons.enable && H.call(this), a.keyboard.enable && U.call(this), (o.bindEvents = !0);
      }
    }),
    (B = function () {
      var t = e(this),
      ...
      if ((a.advanced.releaseDraggableSelectors && r.add(e(a.advanced.releaseDraggableSelectors)), a.advanced.extraDraggableSelectors && r.add(e(a.advanced.extraDraggableSelectors)), o.bindEvents)) {
    ...
    (T = function (t) {
      ...
      "x" !== n.axis &&
        (a.overflowed[0] && !t
          ? (l[0].add(c[0]).add(l[0].children("a")).css("display", "block"), r.removeClass(s[8] + " " + s[10]))
          : (n.alwaysShowScrollbar ? (2 !== n.alwaysShowScrollbar && c[0].css("display", "none"), r.removeClass(s[10])) : (l[0].css("display", "none"), r.addClass(s[10])), r.addClass(s[8]))),
        "y" !== n.axis &&
          (a.overflowed[1] && !t
            ? (l[1].add(c[1]).add(l[1].children("a")).css("display", "block"), r.removeClass(s[9] + " " + s[11]))
            : (n.alwaysShowScrollbar ? (2 !== n.alwaysShowScrollbar && c[1].css("display", "none"), r.removeClass(s[11])) : (l[1].css("display", "none"), r.addClass(s[11])), r.addClass(s[9]))),
    ...
    (M = function () {
      var t,
        ...
        s = i.opt,
        c = "mCS_" + i.idx,
        d = ["mCSB_" + i.idx + "_dragger_vertical", "mCSB_" + i.idx + "_dragger_horizontal"],
        u = e("#mCSB_" + i.idx + "_container"),
        f = e("#" + d[0] + ",#" + d[1]),
        m = s.advanced.releaseDraggableSelectors ? f.add(e(s.advanced.releaseDraggableSelectors)) : f,
        h = W() ? top.document : document,
        p = s.advanced.extraDraggableSelectors ? e(h).add(e(s.advanced.extraDraggableSelectors)) : e(h);
      function g(e, o, a, r) {
        if (((u[0].idleTimer = s.scrollInertia < 233 ? 250 : 0), t.attr("id") === d[1]))
          var l = "x",
            c = (t[0].offsetLeft - o + r) * i.scrollRatio.x;
        else
          var l = "y",
            c = (t[0].offsetTop - e + a) * i.scrollRatio.y;
        N(n, c.toString(), { dir: l, drag: !0 });
      }
      f
        .bind("contextmenu." + c, function (e) {
          e.preventDefault();
        })
        .bind("mousedown." + c + " touchstart." + c + " pointerdown." + c + " MSPointerDown." + c, function (i) {
          if ((i.stopImmediatePropagation(), i.preventDefault(), K(i))) {
            ...
            var c = (t = e(this)).offset(),
              ...
              m = t.height() + c.top,
              h = t.width() + c.left;
            d < m && d > 0 && f < h && f > 0 && ((o = d), (a = f)), w(t, "active", s.autoExpandScrollbar);
          }
        })
        ...
        e(document)
          .add(p)
          .bind("mousemove." + c + " pointermove." + c + " MSPointerMove." + c, function (e) {
            if (t) {
              var n = t.offset(),
                i = k(e)[0] - n.top,
                r = k(e)[1] - n.left;
          ...
          .add(m)
          .bind("mouseup." + c + " touchend." + c + " pointerup." + c + " MSPointerUp." + c, function (e) {
            t && (w(t, "active", s.autoExpandScrollbar), (t = null)), (l = !1), r && (document.onselectstart = null), R.call(u, !0);
          });
    }),
    (O = function () {
      var o,
        ...
        _ = "mCS_" + x.idx,
        w = e("#mCSB_" + x.idx),
        C = e("#mCSB_" + x.idx + "_container"),
        b = [e("#mCSB_" + x.idx + "_dragger_vertical"), e("#mCSB_" + x.idx + "_dragger_horizontal")],
        y = [],
        B = [],
        T = 0,
        M = "yx" === S.axis ? "none" : "all",
        O = [],
        I = C.find("iframe"),
        D = ["touchstart." + _ + " pointerdown." + _ + " MSPointerDown." + _, "touchmove." + _ + " pointermove." + _ + " MSPointerMove." + _, "touchend." + _ + " pointerup." + _ + " MSPointerUp." + _],
        E = void 0 !== document.body.style.touchAction && "" !== document.body.style.touchAction;
      function R(e) {
        if (!Z(e) || l || k(e)[2]) t = 0;
        else {
          (t = 1), (p = 0), (g = 0), (o = 1), v.removeClass("mCS_touch_action");
          var i = C.offset();
          (a = k(e)[0] - i.top), (n = k(e)[1] - i.left), (O = [k(e)[0], k(e)[1]]);
        }
      }
      function A(e) {
        if (Z(e) && !l && !k(e)[2] && (S.documentTouchScroll || e.preventDefault(), e.stopImmediatePropagation(), (!g || p) && o)) {
          c = Q();
          var t = w.offset(),
            i = k(e)[0] - t.top,
            r = k(e)[1] - t.left;
          if ((y.push(i), B.push(r), (O[2] = Math.abs(k(e)[0] - O[0])), (O[3] = Math.abs(k(e)[1] - O[1])), x.overflowed[0]))
          ...
          d || f ? (E || e.preventDefault(), (p = 1)) : ((g = 1), v.addClass("mCS_touch_action")),
            E && e.preventDefault(),
      ...
      function L(e) {
        if (!Z(e) || l || k(e)[2]) t = 0;
          ...
          (t = 1), e.stopImmediatePropagation(), X(v), (s = Q());
          var o = w.offset();
          (i = k(e)[0] - o.top), (r = k(e)[1] - o.left), (y = []), (B = []);
        }
      }
      function z(e) {
        if (Z(e) && !l && !k(e)[2]) {
          (o = 0), e.stopImmediatePropagation(), (p = 0), (g = 0), (d = Q());
          var t = w.offset(),
            a = k(e)[0] - t.top,
            n = k(e)[1] - t.left;
          if (!(d - c > 30)) {
            ...
            (m = "yx" === S.axis ? [T[0], T[1]] : "x" === S.axis ? [null, T[1]] : [T[0], null]), (h = [4 * b[0] + S.scrollInertia, 4 * b[1] + S.scrollInertia]);
            var O = parseInt(S.contentTouchScroll) || 0;
            (m[0] = b[0] > O ? m[0] : 0), (m[1] = b[1] > O ? m[1] : 0), x.overflowed[0] && H(m[0], h[0], "mcsEaseOut", "y", M, !1), x.overflowed[1] && H(m[1], h[1], "mcsEaseOut", "x", M, !1);
          }
        }
      }
      function P(e, t) {
      ...
      function H(e, t, o, a, n, i) {
        e && N(v, e.toString(), { dur: t, scrollEasing: o, dir: a, overwrite: n, drag: i });
      }
    ...
    (I = function () {
      var o,
        ...
        d = c.parent();
      function u(e, t, n) {
        (r.type = n && o ? "stepped" : "stepless"), (r.scrollAmount = 10), F(a, e, t, "mcsLinearOut", n ? 60 : null);
      }
      c.bind("mousedown." + s, function (e) {
        ...
        .bind("mousemove." + s, function (e) {
          if (!t && o && (window.getSelection ? window.getSelection().toString() : document.selection && "Control" != document.selection.type && document.selection.createRange().text)) {
            ...
            l > 0 && l < d.height() && s > 0 && s < d.width() ? r.step && u("off", null, "stepped") : ("x" !== i.axis && n.overflowed[0] && (l < 0 ? u("on", 38) : l > d.height() && u("on", 40)), "y" !== i.axis && n.overflowed[1] && (s < 0 ? u("on", 37) : s > d.width() && u("on", 39)));
          }
        })
        .bind("mouseup." + s + " dragend." + s, function (e) {
          t || (o && ((o = 0), u("off", null)), (l = !1));
        });
    }),
    (D = function () {
      if (e(this).data("mCS")) {
        ...
        s.length &&
          s.each(function () {
            e(this).bind("load", function () {
              W(this) &&
                e(this.contentDocument || this.contentWindow.document).bind("mousewheel." + n, function (e, t) {
                  c(e, t);
                });
            });
          }),
        ...
        if ((X(t), !A(t, n.target))) {
          ...
          if ("x" === a.axis || "x" === a.mouseWheel.axis)
            var u = "x",
              ...
              m = "auto" !== a.mouseWheel.scrollAmount ? f[1] : f[0] >= i.width() ? 0.9 * i.width() : f[0],
            ...
            var u = "y",
              ...
              m = "auto" !== a.mouseWheel.scrollAmount ? f[1] : f[0] >= i.height() ? 0.9 * i.height() : f[0],
          ...
          ("y" === u && !o.overflowed[0]) ||
            ("x" === u && !o.overflowed[1]) ||
            ((a.mouseWheel.invert || n.webkitDirectionInvertedFromDevice) && (v = -v),
            a.mouseWheel.normalizeDelta && (v = v < 0 ? -1 : 1),
            ((v > 0 && 0 !== p) || (v < 0 && p !== g) || a.mouseWheel.preventDefault) && (n.stopImmediatePropagation(), n.preventDefault()),
            n.deltaFactor < 5 && !a.mouseWheel.normalizeDelta && ((m = n.deltaFactor), (d = 17)),
            N(t, (h - v * m).toString(), { dir: u, dur: d }));
        }
      }
    }),
    (E = new Object()),
      ...
      c.bind("mousedown." + n + " touchstart." + n + " pointerdown." + n + " MSPointerDown." + n, function (o) {
        ...
        .bind("click." + n, function (n) {
          if (t && ((t = 0), e(n.target).hasClass(s[12]) || e(n.target).hasClass("mCSB_draggerRail"))) {
            ...
            N(o, f.toString(), { dir: d, scrollEasing: "mcsEaseInOut" });
          }
        });
    }),
    (z = function () {
      ...
      i.bind("focusin." + n, function (o) {
        ...
        n.is(a.advanced.autoScrollOnFocus) &&
          ...
          (t[0]._focusTimeout = setTimeout(function () {
            ...
            "x" === a.axis || l[0] || N(t, e[0].toString(), { dir: "y", scrollEasing: "mcsEaseInOut", overwrite: s, dur: 0 }), "y" === a.axis || l[1] || N(t, e[1].toString(), { dir: "x", scrollEasing: "mcsEaseInOut", overwrite: s, dur: 0 });
          }, t[0]._focusTimer)));
      });
    }),
    (P = function () {
    ...
    (U = function () {
      ...
      function f(i) {
        switch (i.type) {
          ...
          case "keyup":
            ...
            if (("x" !== a.axis && (38 === r || 40 === r)) || ("y" !== a.axis && (37 === r || 39 === r))) {
              ...
              "keyup" === i.type && (d = "off"), e(document.activeElement).is(c) || (i.preventDefault(), i.stopImmediatePropagation(), h(d, r));
            } else if (33 === r || 34 === r) {
              if (((o.overflowed[0] || o.overflowed[1]) && (i.preventDefault(), i.stopImmediatePropagation()), "keyup" === i.type)) {
                ...
                if ("x" === a.axis || ("yx" === a.axis && o.overflowed[1] && !o.overflowed[0]))
                  var f = "x",
                    m = Math.abs(l[0].offsetLeft) - u * (0.9 * s.width());
                else
                  var f = "y",
                    m = Math.abs(l[0].offsetTop) - u * (0.9 * s.height());
                N(t, m.toString(), { dir: f, scrollEasing: "mcsEaseInOut" });
              }
            } else if ((35 === r || 36 === r) && !e(document.activeElement).is(c) && ((o.overflowed[0] || o.overflowed[1]) && (i.preventDefault(), i.stopImmediatePropagation()), "keyup" === i.type)) {
              if ("x" === a.axis || ("yx" === a.axis && o.overflowed[1] && !o.overflowed[0]))
                var f = "x",
        ...
        function h(e, i) {
          (n.type = a.keyboard.scrollType), (n.scrollAmount = a.keyboard.scrollAmount), ("stepped" === n.type && o.tweenRunning) || F(t, e, i);
        }
      }
      d.length &&
        d.each(function () {
    ...
    (F = function (t, o, a, n, i) {
      ...
      switch (o) {
        case "on":
          if (((c.dir = [a === s[16] || a === s[15] || 39 === a || 37 === a ? "x" : "y", a === s[13] || a === s[15] || 38 === a || 37 === a ? -1 : 1]), X(t), $(a) && "stepped" === c.type)) return;
          h(u);
          break;
        case "off":
          clearTimeout(c.step), J(c, "step"), X(t), (u || (r.tweenRunning && c.dir)) && h(!0);
      }
      function h(e) {
        ...
        e && a < 17 && (x = "x" === c.dir[0] ? u[1] : u[0]),
          N(t, x.toString(), { dir: c.dir[0], scrollEasing: S, dur: a, onComplete: _ }),
          e
            ? (c.dir = !1)
            : (clearTimeout(c.step),
    ...
    (q = function (t) {
      ...
      return (
        ...
        t instanceof Array ? (a = t.length > 1 ? [t[0], t[1]] : "x" === o.axis ? [null, t[0]] : [t[0], null]) : ((a[0] = t.y ? t.y : t.x || "x" === o.axis ? null : t), (a[1] = t.x ? t.x : t.y || "y" === o.axis ? null : t)),
      ...
      if (null != t && void 0 !== t) {
        ...
        switch (s) {
          ...
          case "number":
            ...
            if (-1 !== t.indexOf("px") && $(t.split("px")[0])) return Math.abs(t.split("px")[0]);
            ...
            return e(t).length ? ("x" === o ? ee(e(t))[1] : ee(e(t))[0]) : (r.css(f, t), void c.update.call(null, a[0]));
        }
      }
    }),
    (Y = function (t) {
      var o = e(this),
        ...
        n = a.opt,
        i = e("#mCSB_" + a.idx + "_container");
      if (t) return clearTimeout(i[0].autoUpdate), void J(i[0], "autoUpdate");
      function r(e) {
        clearTimeout(i[0].autoUpdate), c.update.call(null, o[0], e);
      }
      !(function t() {
          ...
          0 !== o.parents("html").length
            ? (i[0].autoUpdate = setTimeout(function () {
                return n.advanced.updateOnSelectorChange &&
                  ...
                  ? ((a.poll.change.o = a.poll.change.n), void r(3))
                  : n.advanced.updateOnContentResize && ((a.poll.size.n = o[0].scrollHeight + o[0].scrollWidth + i[0].offsetHeight + o[0].offsetHeight + o[0].offsetWidth), a.poll.size.n !== a.poll.size.o)
                  ? ((a.poll.size.o = a.poll.size.n), void r(1))
                  : !n.advanced.updateOnImageLoad || ("auto" === n.advanced.updateOnImageLoad && "y" === n.axis) || ((a.poll.img.n = i.find("img").length), a.poll.img.n === a.poll.img.o)
                      ...
                      !(function (t) {
                        if (e(t).hasClass(s[2])) r();
                          ...
                          (n.onload =
                            ((o = n),
                            (a = function () {
                              (this.onload = null), e(t).addClass(s[2]), r(2);
                            }),
                            function () {
    ...
    (N = function (t, o, a) {
      var n = t.data("mCS"),
        i = n.opt,
        r = { trigger: "internal", dir: "y", scrollEasing: "mcsEaseOut", drag: !1, dur: i.scrollInertia, overwrite: "all", callbacks: !0, onStart: !0, onUpdate: !0, onComplete: !0 },
        a = e.extend(r, a),
      ...
      if (
        ((n.trigger = a.trigger),
        (0 === d.scrollTop() && 0 === d.scrollLeft()) || (e(".mCSB_" + n.idx + "_scrollbar").css("visibility", "visible"), d.scrollTop(0).scrollLeft(0)),
        "_resetY" !== o || n.contentReset.y || (y("onOverflowYNone") && i.callbacks.onOverflowYNone.call(t[0]), (n.contentReset.y = 1)),
        "_resetX" !== o || n.contentReset.x || (y("onOverflowXNone") && i.callbacks.onOverflowXNone.call(t[0]), (n.contentReset.x = 1)),
        "_resetY" !== o && "_resetX" !== o)
      ) {
        if (
          ((!n.contentReset.y && t[0].mcs) || !n.overflowed[0] || (y("onOverflowY") && i.callbacks.onOverflowY.call(t[0]), (n.contentReset.x = null)),
          (!n.contentReset.x && t[0].mcs) || !n.overflowed[1] || (y("onOverflowX") && i.callbacks.onOverflowX.call(t[0]), (n.contentReset.x = null)),
          i.snapAmount)
        ) {
        ...
        x[1] < 0 || (0 === x[0] && 0 === x[1]) ? (x = [0, 0]) : x[1] >= v[1] ? (x = [v[0], v[1]]) : (x[0] = -x[0]),
          t[0].mcs || (B(), y("onInit") && i.callbacks.onInit.call(t[0])),
          clearTimeout(c[0].onCompleteTimeout),
          V(h[0], p, Math.round(x[1]), l[1], a.scrollEasing),
          (!n.tweenRunning && ((0 === g && x[0] >= 0) || (g === v[0] && x[0] <= v[0]))) ||
            V(c[0], p, Math.round(x[0]), l[0], a.scrollEasing, a.overwrite, {
              onStart: function () {
                a.callbacks && a.onStart && !n.tweenRunning && (y("onScrollStart") && (B(), i.callbacks.onScrollStart.call(t[0])), (n.tweenRunning = !0), w(h), (n.cbOffsets = [i.callbacks.alwaysTriggerOffsets || g >= v[0] + S, i.callbacks.alwaysTriggerOffsets || g <= -_]));
              },
              onUpdate: function () {
                a.callbacks && a.onUpdate && y("whileScrolling") && (B(), i.callbacks.whileScrolling.call(t[0]));
              },
              onComplete: function () {
                if (a.callbacks && a.onComplete) {
                  ...
                  c[0].onCompleteTimeout = setTimeout(function () {
                    y("onScroll") && (B(), i.callbacks.onScroll.call(t[0])),
                      y("onTotalScroll") && x[1] >= v[1] - C && n.cbOffsets[0] && (B(), i.callbacks.onTotalScroll.call(t[0])),
                      y("onTotalScrollBack") && x[1] <= b && n.cbOffsets[1] && (B(), i.callbacks.onTotalScrollBack.call(t[0])),
                      (n.tweenRunning = !1),
                      (c[0].idleTimer = 0),
                      w(h, "hide");
                  }, e);
      ...
      function B() {
        var e = [c[0].offsetTop, c[0].offsetLeft],
          ...
          i = [s.height(), s.width()];
        t[0].mcs = { content: c, top: e[0], left: e[1], draggerTop: o[0], draggerLeft: o[1], topPct: Math.round((100 * Math.abs(e[0])) / (Math.abs(n[0]) - i[0])), leftPct: Math.round((100 * Math.abs(e[1])) / (Math.abs(n[1]) - i[1])), direction: a.dir };
      }
    }),
    (V = function (e, t, o, a, n, i, r) {
      ...
      var v = o - h;
      function x() {
        g.stop || (m || c.call(), (m = Q() - f), S(), m >= g.time && ((g.time = m > g.time ? m + l - (m - g.time) : m + l - 1), g.time < m + 1 && (g.time = m + 1)), g.time < a ? (g.id = s(x)) : u.call());
      }
      function S() {
        a > 0
      ...
      (g.stop = 0),
        "none" !== i && null != g.id && (window.requestAnimationFrame ? window.cancelAnimationFrame(g.id) : clearTimeout(g.id), (g.id = null)),
        (l = 1e3 / 60),
        (g.time = m + l),
        ...
        e.extend(e.expr[":"], {
          mcsInView:
            ...
            function (t) {
              ...
              if (i.length) return (o = i.parent()), (a = [i[0].offsetTop, i[0].offsetLeft])[0] + ee(n)[0] >= 0 && a[0] + ee(n)[0] < o.height() - n.outerHeight(!1) && a[1] + ee(n)[1] >= 0 && a[1] + ee(n)[1] < o.width() - n.outerWidth(!1);
            },
          mcsInSight:
            e.expr[":"].mcsInSight ||
            function (t, o, a) {
