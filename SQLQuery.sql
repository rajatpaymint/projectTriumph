...
INSERT INTO subscriptionList (id, name, amount, subscriptionId, description, createdDate, status) VALUES ('abc3', 'Premium Plan - 1 year', 1199, '3', 'Exclusive access to premium articles and resources',CURRENT_TIMESTAMP, 'active')
