...
function PrimaryButton({ children, buttonPress, buttonWidth }) {
  const outerContainerStyles = [styles.buttonOuterContainer];
  if (buttonWidth > 0) {
    outerContainerStyles.push({ width: buttonWidth });
  }
  return (
