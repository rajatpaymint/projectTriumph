...
async function generateAndSharePDF(text, industry) {
  const imageUrl = "https://z2papppublicbucket.s3.ap-south-1.amazonaws.com/Logo/z2pLogo.png";
  const htmlContent = `
    <html>
    <head>
      <style>
    ...
    <body>
      <img src="${imageUrl}" alt="Market Report Image">
      <h1>Market report on ${industry} generated by B2Z</h1>
...
function MarketResearchStage3({ marketReport = Data, industry }) {
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={[styles.text, { marginBottom: 0, fontWeight: "bold", color: Colors.primary500, fontSize: 18 }]}>Market report on {industry} generated by B2Z</Text>
